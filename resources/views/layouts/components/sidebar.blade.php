<aside class="main-sidebar sidebar-light-success elevation-3">
    ...
    <!-- BRAND -->
    <a href="{{ route('admin.dashboard') }}" class="brand-link d-flex align-items-center px-3">
        <div class="brand-image d-flex align-items-center justify-content-center"
             style="width:40px;height:40px;border-radius:50%;background:#28a745;color:white;font-weight:bold;">
            TK
        </div>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-4 pb-3 mb-3 d-flex align-items-center px-3">
            ...
            <div class="info ml-3">
                ...
                <a href="{{ route('admin.profile.edit') }}" class="text-success small d-block mt-1">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                ...
                <!-- MASTER DATA -->
                <li class="nav-header text-uppercase text-muted">Master Data</li>

                <li class="nav-item">
                    <a href="{{ route('admin.outlet.index') }}" class="nav-link {{ request()->routeIs('admin.outlet.*') ? 'active bg-success' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.bahan.index') }}" class="nav-link {{ request()->routeIs('admin.bahan.*') ? 'active bg-success' : '' }}">
                ...
                <!-- TRANSAKSI -->
                <li class="nav-header text-uppercase text-muted">Transaksi</li>

                <li class="nav-item">
                    <a href="{{ route('admin.stok-masuk.index') }}" class="nav-link {{ request()->routeIs('admin.stok-masuk.*') ? 'active bg-success' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.distribusi.index') }}" class="nav-link {{ request()->routeIs('admin.distribusi.*') ? 'active bg-success' : '' }}">
                ...
                <!-- KOMUNIKASI -->
                <li class="nav-header text-uppercase text-muted">Komunikasi</li>
