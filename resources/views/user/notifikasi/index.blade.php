...
{{-- 1. Mengisi judul di header AdminLTE (Bagian atas) --}}
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-12 d-flex justify-content-between align-items-start">
            <div>
                {{-- Judul H3 dihapus karena sudah ada di @section('page') --}}
                <p class="text-muted small mb-0">Pantau stok kritis dan pengiriman barang untuk outlet Anda.</p>
            </div>
...
<style>
    ...
    .btn-white { background: white; border-color: #dee2e6 !important; }
