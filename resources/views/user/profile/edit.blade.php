...
@section('content')
<div class="col-md-4">
    <div class="card profile-user-card shadow-sm">
        <div class="card-body text-center">
            <img src="{{ $user->photo ? asset('uploads/profile/'.$user->photo) : 'https://ui-avatars.com/api/?name='.$user->name }}"
...
<div class="col-md-8">
    <div class="card profile-user-right-card shadow-sm">
        {{-- Tab content sama kayak admin pusat --}}
    </div>
</div>
