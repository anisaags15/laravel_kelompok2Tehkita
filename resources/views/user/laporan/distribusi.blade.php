                    ...
                    <div class="card p-3 h-100 border-0 shadow-sm">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                @php
                                $last = $distribusi->first();
                                @endphp

                                @if($last)
                                    <div class="fw-bold small">
                                        {{ \Carbon\Carbon::parse($last->updated_at)->diffForHumans() }}
                                    </div>
                                    <div class="tanggal">
                                        {{ \Carbon\Carbon::parse($last->updated_at)->translatedFormat('d M Y') }}
                                    </div>
                                    <div class="jam">
                                        {{ \Carbon\Carbon::parse($last->updated_at)->format('H:i') }} WIB
                                    </div>
                                @else
                                    -
                                @endif
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th width="20%">Periode Bulan</th>
                                    <th>Unit Outlet</th>
                                    <th width="20%" class="text-center">Jumlah Barang Dikirim</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-5">
                                        ...
                                        <p class="text-muted">Ops! Belum ada data distribusi.</p>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
